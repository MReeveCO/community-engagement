  ...
  return (
    <Box sx={{ userSelect: "none", touchAction: "pan-y" }}>
      <Stack
        ...
        sx={{ mb: 2 }}
      >
        <Typography variant="h6">Local Area Questions</Typography>
        {adminMode && (
        ...
        <Box sx={{ position: "relative", height: 300, width: 300, mx: 'auto' }}>
          ...
          <Typography
            sx={{
              ...
              textShadow: "3px 3px 0px #000, -3px -3px 0px #000, 3px -3px 0px #000, -3px 3px 0px #000, 0 0 12px rgba(0,0,0,0.9)",
              zIndex: 1,
            }}
            style={{ transform: `translate(-50%, -50%) scale(${1 + noOpacity * 0.3})` }}
          >
            No
          </Typography>
          <Typography
            ...
            style={{ transform: `translate(-50%, -50%) scale(${1 + yesOpacity * 0.3})` }}
          >
            Yes
          </Typography>
          <Box
          ...
          return (
            ...
            >
              ...
              >
                <Typography>
                  Your answer:{" "}
                  {userAns === undefined ? "—" : userAns ? "Yes" : "No"}
                </Typography>
                <Typography>
                  Area: {s.percentTrue}% Yes ({s.trueCount}/{s.total})
                </Typography>
              </Stack>
              <Box
                sx={{
  ...
  return (
    <Box sx={{ minHeight: "100vh", bgcolor: "background.default" }}>
      ...
      <Container maxWidth="sm" sx={{ py: 3 }}>
        ...
        {tab === 0 && <SwipeQuiz adminMode={adminMode} />}

        {tab === 1 && <YourArea refreshKey={areaRefresh} />}
